(function(){
  ...
  /**
   * Send a chat completion request to xAI Grok with prepared messages.
  ...
  /**
   * Verify API key and model access by calling the models endpoint.
  ...
  /**
   * Simple HTML wrapper for display purposes.
   * @param {string} inner
   * @param {string} [title]
   * @returns {string}
   */
