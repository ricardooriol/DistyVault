...
function App() {
  ...
  const handleDownloadBulk = async (ids) => {
    ...
    for (const it of targets) {
      ...
      printContainer.className = 'dv-reader-body';
      ...
      printContainer.innerHTML = `
        <div style="margin-bottom: 40px; border-bottom: 2px solid #e2e8f0; padding-bottom: 20px;">
          <h1 style="font-size: 32px; font-weight: 800; margin: 0 0 16px 0; color: #0f172a; line-height: 1.2;">${escapeH(it.title || 'Distilled Content')}</h1>
